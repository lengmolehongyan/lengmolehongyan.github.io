...
task :new_post, :title do |t, args|
  ...
  open(filename, 'w') do |post|
    ...
    post.puts "keywords: #keyword"
    post.puts "description: #seo 的 desc"
    post.puts "---"
  end
end
...
multitask :push do
  ...
  cd "#{deploy_dir}" do
    ...
    system "git remote add gitcafe git@gitcafe.com:lengmolehongyan/lengmolehongyan.git >> /dev/null 2>&1"
